...
namespace KursovaWork.Services.MainServices.OrderService
{
    /// <summary>
    ...
    public class OrderService : IOrderService
    {
        ...
        public int AddOrderLoggedIn(CarInfo _curCar)
        {
            ...
            if (ConfiguratorController.options != null)
            {
                order.ConfiguratorOptions = ConfiguratorController.options;
